...
/*
	pSrc := flag.String("src", "src/main/java", "output directory for generated source tree, relative to dir. Target-specific")
	pRez := flag.String("rez", "src/main/resources", "output directory for generated resources, relative to dir. Target-specific")
...
/*func DefaultServerConfig() map[string]interface{} {
